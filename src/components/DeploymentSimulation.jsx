  ...
  return (
    ...
    >
      <div className="text-center mb-10 md:mb-16">
        <h3 className="text-2xl sm:text-3xl md:text-5xl font-black text-white mb-4 flex justify-center items-center gap-2 md:gap-3 font-display">
          <RefreshCw className={`text-indigo-400 ${isDeploying && activeStep < steps.length ? 'animate-spin' : ''}`} size={32} /> 
          Live <span className="gradient-text">Deployment Pipeline</span>
        </h3>
        <p className="text-gray-400 text-sm md:text-base">Simulating a zero-downtime production deployment.</p>
        <div className="w-24 h-1.5 bg-gradient-to-r from-blue-500 to-indigo-500 mx-auto mt-6 rounded-full"></div>
      </div>

      <div className="glass-card rounded-[2rem] md:rounded-[2.5rem] p-6 sm:p-8 md:p-16 border border-white/10 relative overflow-hidden">
