  ...
  return (
    ...
    >
      <div className="text-center mb-16">
        ...
        <p className="text-gray-400">Beyond the tools, it's about the engineering mindset.</p>
      ...
      <div className="grid md:grid-cols-2 gap-8">
        {reasons.map((item, i) => (
          <motion.div 
            ...
            className={`glass-card rounded-[2rem] p-8 border border-${item.color}-500/10 hover:border-${item.color}-500/30 transition-all group relative overflow-hidden`}
          >
